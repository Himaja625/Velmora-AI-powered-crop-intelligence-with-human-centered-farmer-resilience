...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-DGKc9AX8.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cfbx4Cmu.mjs");
...
var manifest = {
	"9a495fc54678410630e7b724ff9a1b70c6948dbfb0b94565527e4d1704ddc1e0": {
		functionName: "fetchWeatherServerFn_createServerFn_handler",
		importer: () => import("./weather-BCV5sPjX.mjs")
	},
	"9eb927ef849c6a4ccc4270c7eb454c246ba8d012730b5ad40e4a6723ce3a2a8a": {
		functionName: "analyzeCropImageServerFn_createServerFn_handler",
		importer: () => import("./crop-vision-DRDjsL1e.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DqkL3bZ-.mjs").then((n) => n.t),
